...
<head>
    ...
    <!-- User Dashboard Theme Colors (Static CSS) -->
    <link rel="stylesheet" href="{{ asset('assets/templates/basic/css/theme-colors.css') }}?v={{ time() }}">
    
    <!-- Frontend Public Theme Colors (Static CSS) -->
    <link rel="stylesheet" href="{{ asset('assets/templates/basic/css/frontend-colors.css') }}?v={{ time() }}">
